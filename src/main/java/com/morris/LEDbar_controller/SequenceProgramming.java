            ...
            for (Map.Entry<String, ?> entry : allEntries.entrySet()) {
                ...
                if (sKey.equals(sSeqName)) {
                    ...
                    for (int i = 1; i<= iRows; i++) {
                        Log.d(TAG, "Sending RGBW+T:" + sValue.charAt((i-1)*19) + "," + sValue.substring((i-1)*19+1, (i-1)*19+4) +"," + sValue.substring((i-1)*19+4, (i-1)*19+7)+"," + sValue.substring((i-1)*19+7, (i-1)*19+10) +"," + sValue.substring((i-1)*19+10, (i-1)*19+13) + "," + sValue.substring((i-1)*19+13, (i-1)*19+19));
